\section{Requisiti non funzionali}\label{RequisitiNonFunzionali}
In questà sezione sono elencati i requisiti non funzionali del sistema BugBoard26, 
ovvero le caratteristiche che il sistema deve possedere per garantire un'esperienza utente ottimale e un funzionamento efficiente.
...
\begin{itemize}
    ...
    \item \textbf{Scalabilità:} Il sistema deve essere in grado di gestire un aumento del numero di utenti e dati senza degradare le prestazioni, fino a un massimo di 1000 utenti simultanei.
\end{itemize}
...
\section{Requisiti di Dominio}\label{RequisitiDominio}
